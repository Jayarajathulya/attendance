...
$result = mysqli_query($conn, "SELECT * FROM wifi1 WHERE branchcode ='" . $_SESSION['branchcode'] . "' ");
...
<body class="items-center bg-zinc-100">
    <div>
        ...
        <section class="">
            ...
            <div class="text-3xl font-semibold text-center pb-4 text-sky-800"> Facility Wifi list</div>
                        ...
                        <table class="w-full border border-separate rounded-t-lg border-spacing-1">
                            <thead>
                                <tr class="font-semibold tracking-wide text-left text-white uppercase bg-pink-600 border-b border-gray-500 text-md">
                                    ...
                                    <th class="w-8 px-4 py-3 whitespace-nowrap ">TOWER NAME</th>
                            ...
                            <tbody>
                                ...
                                $total_pages_sql = "SELECT COUNT(*) FROM wifi1 WHERE branchcode ='" . $_SESSION['branchcode'] . "'";
                                ...
                                $sql = "SELECT * FROM wifi1 WHERE branchcode ='" . $_SESSION['branchcode'] . "' LIMIT $offset, $no_of_records_per_page ";
                                ...
                                <a href=\"wifi_facility_edit.php?edit=$post[id]\" class='inline-flex items-center justify-center px-4 py-2 text-base font-medium leading-6 text-white whitespace-no-wrap border rounded-md shadow-sm border-sky-700 bg-sky-800 hover:bg-sky-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500'>Edit</a> 
