...
<div class="px-20 py-30">
          ...
          ?>
                        <?php 
//select database
$sql="SELECT * FROM `attendance_taken` WHERE branchname ='". $_SESSION['branchname'] ."' AND  attendance LIKE '%absent%' AND date='$Today' ORDER BY id ASC ";
...
while($post=mysqli_fetch_assoc($record)) { 
   ?>
          ...
          ?>
                        <?php 
//select database
$sql="SELECT * FROM `attendance_taken` WHERE branchname ='". $_SESSION['branchname'] ."' AND  attendance LIKE '%off%' AND date='$Today' ORDER BY id ASC ";
$record = mysqli_query($conn,$sql);
while($post=mysqli_fetch_assoc($record)) { 
   ?>
                        <tr>
