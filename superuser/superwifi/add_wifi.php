...
<div class=" px-2 py-2">
    ...
    <div class="flex flex-col flex-auto flex-shrink-0  antialiased text-black bg-zinc-100 ">
            ...
            <div class="flex justify-center text-3xl font-semibold text-center pb-4 text-sky-800">Add Wifi And Intercom</div>
                ...
                <form class="min-w-full p-10 bg-white rounded-lg shadow-xl xl:px-10" method="post" action="">
                    ...
                    <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                         <div class="mb-5">
                                <label for="wifiPassword" class="block mb-2 text-sm font-medium text-gray-900 ">WI-FI Password
                                </label>
                                <input type="text" name="wifipassword" id="wifipassword"   placeholder="Wifi password"  required
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm  rounded-lg focus:ring-sky-500 focus:border-sky-500 block w-full p-2.5">
                                </input>
                            </div>
