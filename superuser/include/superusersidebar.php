...
<body>
    ...
    <div class="w-full mx-auto border-b bg-sky-900 2xl:max-w-full">
        <div x-data="{ open: false }"
            class="relative flex flex-col w-full p-5 mx-auto bg-sky-900 md:items-center md:justify-between md:flex-row md:px-6 lg:px-8">
            <div class="grid justify-items-center">
                <button @click="open = !open"
                    class="inline-flex items-center justify-center p-2 text-gray-400 hover:text-pink-500 focus:outline-none focus:text-pink-500 md:hidden">
            ...
            <nav :class="{'flex': open, 'hidden': !open}"
                class="flex-col items-center flex-grow hidden md:pb-0 md:flex  md:flex-row">
                ...
                <div class="order-last md:order-none" x-data="{ openMobileMenu: false}"
                        ...
                        <nav class="relative flex items-center justify-between w-full sm:h-10">
                            <div class="flex items-center justify-between space-x-4">
                                <div class="space-x-4" x-on:click="openMobileMenu = !openMobileMenu">
                                    ...
                                    <button id="main-menu" aria-label="Main menu" aria-haspopup="true"
                                        class="inline-flex items-center justify-center px-4 py-2 text-base font-medium leading-6 text-white whitespace-no-wrap bg-pink-600 border border-pink-700 rounded-md shadow-sm hover:bg-pink-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
                    ...
                    <div x-on:click="openMobileMenu = false" x-transition:enter="transition ease-out duration-150"
                        ...
                        class="fixed inset-0 top-0 z-40 h-screen overflow-y-auto transition origin-top transform -translate-y-full">
                        <div class="relative overflow-hidden bg-pink-500 shadow-xl lg:bg-transparent" role="menu"
                            aria-orientation="vertical" aria-labelledby="main-menu">
                            <div class="bg-sky-800 lg:border-t fon">
                                <div
                                    class="grid px-4 py-6 mx-auto sm:grid-cols-2 2xl:max-w-7xl gap-y-6 sm:gap-8 sm:px-6 sm:py-6 lg:grid-cols-4 lg:px-6 lg:py-6 xl:py-6">
                                    <div class="grid grid-cols-1 gap-3 p-2 lg:p-0">
                                        <div>
                                            <div
                                                class="relative grid gap-6 px-5 py-6 shadow-xl cursor-pointer sm:gap-8 sm:p-8 ">
                                                ...
                                                <a href="../superattendance/attendancelist.php"
                                                    class="inline-flex items-start p-3 -m-3 transition duration-150 ease-in-out rounded-xl group hover:bg-white">
                                                    <div class="">
                                                        <svg xmlns="http://www.w3.org/2000/svg"
                                                            class="w-8 h-8 text-white group-hover:text-sky-800 md hydrated"
                                                            width="32" height="32" width="32" height="32"
                                                            viewBox="0 0 24 24">
                                                            <path fill="currentColor"
                                                                d="M16 14q-1.25 0-2.125-.875T13 11q0-1.25.875-2.125T16 8q1.25 0 2.125.875T19 11q0 1.25-.875 2.125T16 14Zm-6 6v-1.9q0-.525.25-1t.7-.75q1.125-.675 2.388-1.012T16 15q1.4 0 2.663.338t2.387 1.012q.45.275.7.75t.25 1V20H10Zm2.15-2h7.7q-.875-.5-1.85-.75T16 17q-1.025 0-2 .25t-1.85.75ZM16 12q.425 0 .713-.288T17 11q0-.425-.288-.713T16 10q-.425 0-.713.288T15 11q0 .425.288.713T16 12Zm0-1Zm0 7ZM3 14v-2h8v2H3Zm0-8V4h12v2H3Zm8.1 4H3V8h9q-.35.425-.563.925T11.1 10Z" />
                                                        </svg>
                                                    </div>
                                                    <div class="ml-4">
                                                        <p class="text-base font-medium text-pink-500">
                                                ...
                                                <a href="../superattendance/attendancereport.php"
                                                    class="inline-flex items-start p-3 -m-3 transition duration-150 ease-in-out rounded-xl group hover:bg-white">
                                                    <div class="">
                                                        <svg xmlns="http://www.w3.org/2000/svg"
                                                            class="w-8 h-8 text-white group-hover:text-sky-800 md hydrated"
                                                            ...
                                                            <g fill="none" stroke="currentColor" stroke-linecap="round"
                                                                ...
                                                                <path
                                                                    d="M8 5H6a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h5.697M18 12V7a2 2 0 0 0-2-2h-2" />
                                                                <path
                                                                    d="M8 5a2 2 0 0 1 2-2h2a2 2 0 0 1 2 2v0a2 2 0 0 1-2 2h-2a2 2 0 0 1-2-2zm0 6h4m-4 4h3m3 2.5a2.5 2.5 0 1 0 5 0a2.5 2.5 0 1 0-5 0m4.5 2L21 22" />
                                                            </g>
                                                        </svg>
                                                    </div>
                                                    <div class="ml-4">
                                    ...
                                    <div class="grid grid-cols-1 gap-3 p-2 lg:p-0">
                                        <div>
                                            <div class="relative grid gap-6 px-5 py-6 shadow-xl cursor-pointer sm:gap-8 sm:p-8 ">
                                                ...
                                                <a href="../superwifi/add_wifi.php"
                                                    ...
                                                    <div class="">
                                                        ...
                                                        <svg xmlns="http://www.w3.org/2000/svg"
                                                            ...
                                                            width="32" height="32" viewBox="0 0 24 24">
                                                            <path fill="currentColor"
                                                                d="M18 18h-2q-.425 0-.713-.288T15 17q0-.425.288-.713T16 16h2v-2q0-.425.288-.713T19 13q.425 0 .713.288T20 14v2h2q.425 0 .713.288T23 17q0 .425-.288.713T22 18h-2v2q0 .425-.288.713T19 21q-.425 0-.713-.288T18 20v-2Zm-6.7 2.3L.725 9.725q-.3-.3-.3-.725t.325-.7q2.275-2.125 5.225-3.212T12 4q3.05 0 6.025 1.088T23.25 8.3q.3.275.313.7t-.288.725l-1.7 1.7q-.525-.25-1.1-.388t-1.2-.162L21.1 9.05q-1.975-1.5-4.3-2.275T12 6q-2.475 0-4.8.775T2.9 9.05l9.1 9.1l.875-.875q.025.625.163 1.2t.387 1.1l-.725.725q-.3.3-.7.3t-.7-.3Zm.7-8.225Z" />
                                                        </svg>
                                                    </div>
                                                    <div class="ml-4">
                                                        <p class="text-base font-medium text-pink-500">
                                                            Facility Add wifi and Intercom
                                                        </p>
                                                        <p class="mt-1 text-lg text-white group-hover:text-sky-800">
                                                            Interviews, tutorials and more
                                                        </p>
                                                ...
                                                <a href="../superwifi/list_wifi.php"
                                                    class="inline-flex items-start p-3 -m-3 transition duration-150 ease-in-out rounded-xl group hover:bg-white">
                                                    <div class="">
                                                        <svg class="w-6 h-6 text-white group-hover:text-sky-800 md hydrated"
                                                    ...
                                                    <div class="ml-4">
                                                        <p class="text-base font-medium text-pink-500">
                                                            Facility Wifi and Intercom List
                                                        </p>
                                                        <p class="mt-1 text-lg text-white group-hover:text-sky-800">
                                                ...
                                                <a href="../superwifi/wifi_facility.php"
                                                    class="inline-flex items-start p-3 -m-3 transition duration-150 ease-in-out rounded-xl group hover:bg-white">
                                                    <div class="">
                                                        ...
                                                        <svg xmlns="http://www.w3.org/2000/svg"
                                                            ...
                                                            width="32" height="32" viewBox="0 0 24 24">
                                                            <path fill="currentColor"
                                                                d="M12 20.575q-.2 0-.375-.062T11.3 20.3L.7 9.7q-.3-.3-.288-.712T.725 8.3Q3.05 6.2 5.95 5.1T12 4q3.15 0 6.05 1.1t5.225 3.2q.3.275.313.688T23.3 9.7L12.7 20.3q-.15.15-.325.213t-.375.062Z" />
                                                        </svg>
                                                    </div>
                                                    <div class="ml-4">
                                                        <p class="text-base font-medium text-pink-500">
                                                ...
                                                <!-- <a href="../superwifi/wifi_facility_office_add.php"
                                                    class="inline-flex items-start p-3 -m-3 transition duration-150 ease-in-out rounded-xl group hover:bg-white">
                                                    <div class="">
                                                ...
                                                <a href="../superwifi/wifi_facility_office_list.php"
                                                    class="inline-flex items-start p-3 -m-3 transition duration-150 ease-in-out rounded-xl group hover:bg-white">
                                                    <div class="">
                                                        <svg class="w-6 h-6 text-white group-hover:text-sky-800 md hydrated"
                                                            xmlns="http://www.w3.org/2000/svg" width="32" height="32"
                                    ...
                                    <div class="grid grid-cols-1 gap-3 p-2 shadow-xl lg:p-0 ">
                                        <div>
                                            <div class="relative grid gap-6 px-5 py-6 sm:gap-8 sm:p-8">
                                                ...
                                                <!-- <a href="../superIntercom/facilityintercom.php"
                                                    class="inline-flex items-start p-3 -m-3 transition duration-150 ease-in-out rounded-xl group hover:bg-white">
                                                    <div class="">
                                                ...
                                                <a href="../superIntercom/facilityintercomadd.php"
                                                    class="inline-flex items-start p-3 -m-3 transition duration-150 ease-in-out rounded-xl group hover:bg-white">
                                                    <div class="">
                                                ...
                                                <a href="../superIntercom/facilityintercomlist.php"
                                                    class="inline-flex items-start p-3 -m-3 transition duration-150 ease-in-out rounded-xl group hover:bg-white">
                                                    <div class="">
                                                        <svg xmlns="http://www.w3.org/2000/svg"
                                                            class="w-6 h-6 text-white group-hover:text-sky-800 md hydrated"
                                                ...
                                                <a href="../mastertable/adminregistration.php"
                                                    class="inline-flex items-start p-3 -m-3 transition duration-150 ease-in-out rounded-xl group hover:bg-white">
                                                    <div class="">
                                                ...
                                                <a href="../mastertable/masterdepartment.php"
                                                    class="inline-flex items-start p-3 -m-3 transition duration-150 ease-in-out rounded-xl group hover:bg-white">
                                                    <div class="">
                                                ...
                                                <a href="../mastertable/masterfacility.php"
                                                    class="inline-flex items-start p-3 -m-3 transition duration-150 ease-in-out rounded-xl group hover:bg-white">
                                                    <div class="">
                                                ...
                                                <a href="../mastertable/master_branches.php"
                                                    class="inline-flex items-start p-3 -m-3 transition duration-150 ease-in-out rounded-xl group hover:bg-white">
                                                    <div class="">
