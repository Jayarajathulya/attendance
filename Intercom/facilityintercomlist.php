...
$result = mysqli_query($conn, "SELECT * FROM `intercom` WHERE branchcode ='" . $_SESSION['branchcode'] . "'");
    ...
    ?>
     <div class=" px-2 py-2">
        ...
        <section class="">
            ...
            <div class="text-3xl font-semibold text-center pb-4 text-sky-800"> Facility Intercom list</div>
                        ...
                        <table class="w-full border border-separate rounded-t-lg border-spacing-1">
                            <thead>
                                <tr class="font-semibold tracking-wide text-left text-white uppercase bg-pink-600 border-b border-gray-500 text-md">
                                    ...
                                    <th class="px-4 py-3 whitespace-nowrap ">ROOM N.O</th>
                                    <th class="px-4 py-3 whitespace-nowrap ">PHONE N.O</th>
                                    <th class="px-4 py-3 whitespace-nowrap ">TOWER NAME</th> 
                                    <th class="px-4 py-3 whitespace-nowrap ">BRANCH NAME</th>                                  
                            ...
                            <tbody>
                                ...
                                $total_pages_sql = "SELECT COUNT(*) FROM `intercom` WHERE branchcode ='" . $_SESSION['branchcode'] . "'";
                                ...
                                $sql = "SELECT * FROM `intercom` WHERE branchcode ='" . $_SESSION['branchcode'] . "' LIMIT $offset, $no_of_records_per_page ";
