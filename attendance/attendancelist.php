...
$result = mysqli_query($conn, "SELECT * FROM `employee_details` WHERE branchcode ='" . $_SESSION['branchcode'] . "' ");
...
<body class="bg-zinc-100">
    <div>
        ...
        <section class="">
            ...
            <div class="text-3xl font-semibold text-center pb-4"> Facility Attendance list</div>
